  ...
  return (
    <div className={`relative ${fullWidth ? 'block w-full' : 'inline-block'}`}>
      <select
        ...
        disabled={isUpdating}
        className={`${fullWidth ? 'w-full ' : ''}appearance-none bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2 pr-8 text-sm font-medium text-gray-700 dark:text-gray-200 hover:border-gray-400 dark:hover:border-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent cursor-pointer transition-colors disabled:opacity-50 disabled:cursor-not-allowed`}
      >
